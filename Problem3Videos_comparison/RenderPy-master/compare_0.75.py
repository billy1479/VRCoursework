...
def compare_implementations(csv_file_path, model_path="data/headset.obj", output_video="headset_comparison.mp4"):
    ...
    grav_filter = model_grav.DeadReckoningFilter(alpha=0.75)  # Gravity-corrected implementation
...
def main():
    ...
    try:
        # Run the comparison
        output_path = compare_implementations(imu_data_path, model_path, "headset_comparison_0.75.mp4")
