...
class HeadsetSimulation:
    def __init__(self, width=800, height=600):
        ...
        # Physics settings
        self.friction_coefficient = 0.965
        self.accumulator = 0
    ...
    def create_floor_headsets(self):
        ...
        # Circle of headsets moving inward - Moderate velocities
        num_circle = 8
        circle_radius = 20
        for i in range(num_circle):
            ...
            # Set reasonable velocity
            speed = 2 + (i % 2)  # Reduced speed range
            vel = Vector(
        ...
        # Add "cue ball" white headset with moderate speed
        pos = Vector(0, 1, -25)
        vel = Vector(0, 0, 4)  # Moderate speed
