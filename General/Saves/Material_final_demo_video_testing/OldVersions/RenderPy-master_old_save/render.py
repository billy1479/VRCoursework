...
class ImprovedHeadsetScene:
    ...
    def setup_scene(self):
        """Set up the scene with a central rotating headset positioned further away and smaller"""
        # Create the central headset
        model = Model('data/headset.obj')
        model.normalizeGeometry()
        
        # Position it further from camera
        position = Vector(0, 5, -25)  # Moved from -15 to -25 to be further away
        model.setPosition(position.x, position.y, position.z)
        
        # Make it smaller
        model.scale = [1.0, 1.0, 1.0]  # Reduced from 2.0 to 1.0 to make it smaller
        ...
        self.camera_pos = Vector(0, 10, -40)  # Move camera further back (from -30 to -40)
    ...
    def update_camera(self):
        ...
        # Set camera position further away from the headset
        distance = 20.0  # Increased from 15.0 to 20.0 for better visibility
